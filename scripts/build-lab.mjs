...
let html=await readFile('dist/index.html','utf8');html=html.replace('<title>Neon | ETH / USDT</title>','<title>Neon | Local Testnet</title>').replace('ETHEREUM MAINNET / DIRECT SETTLEMENT','LOCAL TESTNET / DIRECT SETTLEMENT');
